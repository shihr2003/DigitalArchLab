...
::: callout-tip
Make sure to save your project regularly by pressing `Ctrl/CMD` + `s` or the button ![](images/clipboard-2523291974.png){width="5%"} near the top. Alternatively, use an [autosave plugin](https://plugins.qgis.org/plugins/Auto_save/).
:::
...
::: callout-caution
Make sure the coordinate reference system (CRS) in the right bottom corner is set to EPSG:3857 for now, used for display by many web-based mapping tools. This is a [projected coordinate system](https://en.wikipedia.org/wiki/Projected_coordinate_system) that flattens the curved surface of the Earth (as opposed to a [geographic coordinate system](https://en.wikipedia.org/wiki/Geographic_coordinate_system)), and should not be used for rigorous analysis.
:::
...
### Survey Map from Tony Wilkinson (2002)
...
Now look at the western and eastern ends of the ribbon-shaped corrected CORONA image. Compared with the area around Tell Beydar, is the level of detail there finer, coarser, or about the same? Why?
:::
